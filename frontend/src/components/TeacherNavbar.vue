    ...
    <nav class="navbar" :class="{ open }">
      ...
      <router-link to="/lehrer/faecher" class="nav-item" active-class="active">
        <svg class="svg_nav" width="24" height="24" viewBox="0 0 24 24" fill="none"
          ...
          <path
            ...
            stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M21.3999 15V9" stroke="#292D32" stroke-width="1.5" stroke-linecap="round"
      ...
      <router-link to="/lehrer/moodboard" class="nav-item" active-class="active">
        <svg class="svg_nav" width="24" height="24" viewBox="0 0 24 24" fill="none"
          ...
          <path d="M8.07996 13.15C8.07996 13.15 9.45996 15.78 12 15.78C14.54 15.78 15.92 13.15 15.92 13.15"
            stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M9.5 8.5H9.51M14.5 8.5H14.51" stroke="#292D32" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="round" />
        </svg>
        Moodboard
      </router-link>
      ...
      <router-link to="/lehrer/hilfe" class="nav-item" active-class="active">
        <svg class="svg_nav" width="24" height="24" viewBox="0 0 24 24" fill="none"
          ...
          <path
            ...
            stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M9.05005 11.87L10.66 13.48L14.96 9.17999" stroke="#292D32" stroke-width="1.5"
      ...
      <router-link v-if="isAdmin" to="/admin/klassen" class="nav-item" active-class="active">
        <svg class="svg_nav" width="24" height="24" viewBox="0 0 24 24" fill="none"
          ...
          <path d="M12 8V16" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        Admin Bereich
      </router-link>
    </nav>
