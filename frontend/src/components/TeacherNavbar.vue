        ...
        <router-link to="/lehrer/moodboard" class="nav-item" active-class="active">
            <svg class="svg_nav" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M8.07996 13.15C8.07996 13.15 9.45996 15.78 12 15.78C14.54 15.78 15.92 13.15 15.92 13.15"
                    stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M9.5 8.5H9.51M14.5 8.5H14.51" stroke="#292D32" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            Moodboard
        </router-link>
...
import { jwt_decode } from 'jwt-decode'; // Neuer benannter Import
