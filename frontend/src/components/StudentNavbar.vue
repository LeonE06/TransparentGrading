  ...
  <nav class="navbar">
    ...
    <router-link to="/schueler/moodboard" class="nav-item" active-class="active">
      <svg class="svg_nav" width="24" height="24" viewBox="0 0 24 24" fill="none"
        ...
        <path
          d="M8.07996 13.15C8.07996 13.15 9.45996 15.78 12 15.78C14.54 15.78 15.92 13.15 15.92 13.15"
          stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path
          d="M9.5 8.5H9.51M14.5 8.5H14.51"
    ...
    <router-link to="/logout" class="nav-item" active-class="active">
      <svg class="svg_nav" width="24" height="24" viewBox="0 0 24 24" fill="none"
        ...
        <path d="M15.0001 12H3.62012" stroke="#292D32" stroke-width="1.5" stroke-linecap="round"
          stroke-linejoin="round"/>
        <path d="M5.85 8.65002L2.5 12L5.85 15.35" stroke="#292D32" stroke-width="1.5"
